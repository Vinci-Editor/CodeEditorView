//
//  SwiftTreeSitterQueries.swift
//
//  Tree-sitter highlight queries for Swift.
//

import Foundation

enum SwiftTreeSitterQueries {
  /// Swift highlight query (ported from nvim-treesitter).
  ///
  /// SwiftTreeSitter supports `#match?` (not `#lua-match?`), so we translate those predicates.
  static let swiftHighlights: String = rawSwiftHighlights
    .replacingOccurrences(of: "#lua-match?", with: "#match?")

  private static let rawSwiftHighlights: String = #"""
[
  "."
  ";"
  ":"
